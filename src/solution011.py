...
def solution():
    ...
    grid = [i.split() for i in grid.strip().split('\n')]
    ...
    for i in range(20):
        for j in range(17):
            vert.append(
                int(grid[j][i]) * int(grid[j + 1][i]) *
                int(grid[j + 2][i]) * int(grid[j + 3][i]))

    diag_1 = []
    for i in range(17):
        for j in range(17):
            diag_1.append(
                int(grid[j][i]) * int(grid[j + 1][i + 1]) *
                int(grid[j + 2][i + 2]) * int(grid[j + 3][i + 3]))
